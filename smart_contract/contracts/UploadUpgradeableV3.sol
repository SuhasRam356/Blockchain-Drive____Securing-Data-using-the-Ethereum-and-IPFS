...
contract UploadUpgradeableV3 is Initializable, OwnableUpgradeable, UUPSUpgradeable {
    struct FileInfo {
        string url;
        string category;
    ...
    // New V2 function that adds file AND stores its signature
    ...
    // --- V3 FUNCTION ---
    // New V3 function that sends a file to a receiver AND stores its signature
