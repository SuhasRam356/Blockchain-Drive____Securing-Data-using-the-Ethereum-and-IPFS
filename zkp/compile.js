...
try {
    ...
    execSync(".\\circom.exe payload_hash.circom --r1cs --wasm --sym", { stdio: "inherit" });
    ...
    execSync("npx snarkjs powersoftau contribute pot12_0000.ptau pot12_0001.ptau --name=\"First contribution\" -v -e=\"random text\"", { stdio: "inherit" });
    ...
    execSync("npx snarkjs groth16 setup payload_hash.r1cs pot12_final.ptau payload_hash_0000.zkey", { stdio: "inherit" });
    execSync("npx snarkjs zkey contribute payload_hash_0000.zkey payload_hash_final.zkey --name=\"Second contribution\" -v -e=\"another random text\"", { stdio: "inherit" });
    execSync("npx snarkjs zkey export verificationkey payload_hash_final.zkey verification_key.json", { stdio: "inherit" });
    execSync("npx snarkjs zkey export solidityverifier payload_hash_final.zkey Verifier.sol", { stdio: "inherit" });
